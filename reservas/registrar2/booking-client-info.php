                <form onsubmit="insertPerson(this); return false;">
                    <div id="person-index" hidden></div>
                    <div id="person-values" class="modal-body">
                        <div class="card">
                            <div class="card-header">
                                <i class="fa fa-user"></i>
                                <strong class="card-title">Información personal</strong>
                                
                                <div class="switch-group" style="float: right;">
                                        <label class="switch switch-container">
                                            <input id="check-in-state" type="checkbox" onchange="showAllInputs(this);">
                                            <span class="slider slider-gray round green"></span>
                                        </label>
                                        <label id="holder-stay-label" class="switch-label">Check in</label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group in-row">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="search-client" class="form-control" type="text" placeholder="Documento" maxlength="15" onkeypress="searchEvent(event,this);" onkeydown="$(this).mask('000000000000');">
                                            <button type="button" onclick="searchPerson(document.getElementById('search-client'));"><i class="fa fa-search"></i></button>
                                        </div>
                            ...
                            <input id="person-id" type="text" hidden>

                            <div id="person-card-body" class="card-body">
                                <div class="row">
                       ...
                       <div class="col-12">
                            <button id="person-next-button" class="btn btn-block btn-register">
