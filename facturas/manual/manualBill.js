function calcValues(){
    ...
    // document.getElementById("vTotal1").value = new Intl.NumberFormat("es-CO").format(value1);

    // var value2 = ((document.getElementById("cant2").value)*(document.getElementById("unit2").value));
    // document.getElementById("vTotal2").value = new Intl.NumberFormat("es-CO").format(value2);

    // var value3 = ((document.getElementById("cant3").value)*(document.getElementById("unit3").value));
    // document.getElementById("vTotal3").value = new Intl.NumberFormat("es-CO").format(value3);

    // var value4 = ((document.getElementById("cant4").value)*(document.getElementById("unit4").value));
    // document.getElementById("vTotal4").value= new Intl.NumberFormat("es-CO").format(value4);


    // document.getElementById("valueTotal").value = '$'+ new Intl.NumberFormat("es-CO").format(value1 + value2 + value3 + value4);
    ...
    // document.getElementById("valueTotal").value = (parseInt(document.getElementById("vTotal1").value)+parseInt(document.getElementById("vTotal2").value)+parseInt(document.getElementById("vTotal3").value)+parseInt(document.getElementById("vTotal4").value));
}
